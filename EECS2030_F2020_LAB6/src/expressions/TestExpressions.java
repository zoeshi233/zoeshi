...
public class TestExpressions {
	...
	@Test
	public void test00() { // don't move this method
		// Build the expression: 
		// nothing can be evaluated.
		// just test constructor, and static counter,
		
		Expression.numExpressionCreated=0; // needed!!
		Expression dummy = new Expression(0, 0);
		assertEquals(Expression.numExpressionCreated,  1);
	}
	...
	public void test01() {
		...
		assertEquals(Expression.numExpressionCreated,  1+1);
	...
	public void test02() {
		...
		assertEquals(Expression.numExpressionCreated,  1+2);
	}
	...
	public void test03() {
		...
		//System.out.println("test03 "+Expression.numExpressionCreated);
		
		assertEquals(Expression.numExpressionCreated,  3+1);
	}
	...
	public void test04() {
		...
		assertTrue(eq.getValue() instanceof Boolean);
		...
		assertEquals(Expression.numExpressionCreated,  6);
	}
	...
	public void test05() {
		...
		// Evaluate the expression.
		gt.evaluate();
		assertTrue(gt.getValue() instanceof Boolean);
		...
		assertEquals(Expression.numExpressionCreated,  6+3);
	}
	...
	public void test06() {
		...
		// Evaluate the expression.
		lt.evaluate();
		assertTrue(lt.getValue() instanceof Boolean);
		...
		assertEquals(Expression.numExpressionCreated,  9+3);
	}
	...
	public void test12() {
		...
		Expression[] exp = {add,sub, mul};
		assertArrayEquals(exp, ec1Expressions);
