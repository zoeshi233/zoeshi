...
function equation() {
   ...
   if((Math.pow(b,2)-(4*a*c))>=0){
      ...
      document.getElementById("output").innerHTML = "one root: "+x1.toFixed(2)+"<br/>"+"another root: "+x2.toFixed(2);   
   }
   else{
      document.getElementById("output").innerHTML = "one root: undefined"+"<br/>"+"another root: undefined"; 
   }
